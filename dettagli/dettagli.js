        ...
        contenuto.innerHTML += /*html*/
            ...
            <div class="d-flex justify-content-between">
                ...
                <ul class="dettagli">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-cart-plus" viewBox="0 0 16 16" onclick="aggiungiAlCarrello('${product.name}', '${product.price}', '${product.id}' )">
